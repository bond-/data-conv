...
<div class="row">
  ...
  <div class="col-lg-4">
    ...
    <p><a class="btn btn-primary" href="http://gaelyk.appspot.com/tutorial">Read Tutorial &raquo;</a></p>
 </div>
  <div class="col-lg-4">
    <h2>Work Less</h2>
    ...
    <p><a class="btn btn-primary" href="http://gaelyk.appspot.com/plugins">More about plugins &raquo;</a></p>
  </div>
</div>
